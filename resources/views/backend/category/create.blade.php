...
@section('title', __('backend_categories.labels.management') . ' | ' . __('backend_categories.labels.create'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('backend_categories.labels.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    {{ html()->label(__('backend_categories.validation.attributes.request_types_id'))->class('col-md-2 form-control-label')->for('request_types_id') }}
                        ...
                        <div class="col-md-10">
                            {{ html()->select('request_types_id', $requestTypes ?? [], null)->class('form-control')->required() }}
                        </div><!--col-->
                </div><!--form-group-->
