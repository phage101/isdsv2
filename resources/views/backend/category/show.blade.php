        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <div class="form-group row">
                    <label class="col-md-2 form-control-label" for="category">Category</label>

                    <div class="col-md-10">
                        {{ html()->text('category')->class('form-control bg-white')->disabled()->value(old('category', $category->category)) }}
                    </div><!--col-->
                </div><!--form-group-->
            </div><!--col-->
        </div><!--row-->
