        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_categories.labels.management') }} <small class="text-muted">{{ __('backend_categories.labels.active') }}</small>
                </h4>
            </div><!--col-->
                    ...
                    <table id="categories_table" class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="width:0%;white-space:nowrap">{{ __('backend_categories.table.active') ?? 'Active' }}</th>
                                <th style="width:0%;white-space:nowrap">@lang('backend_categories.table.actions')</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
