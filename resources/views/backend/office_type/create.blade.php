...
@section('title', __('backend_office_types.labels.management') . ' | ' . __('backend_office_types.labels.create'))
...
@section('content')
{{ html()->form('POST', route('admin.office_types.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('backend_office_types.labels.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
