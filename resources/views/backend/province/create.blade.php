...
@section('title', __('backend_provinces.labels.management') . ' | ' . __('backend_provinces.labels.create'))
...
@section('content')
{{ html()->form('POST', route('admin.provinces.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('backend_provinces.labels.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
