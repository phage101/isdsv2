    ...
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                ...
                <div class="form-group row">
                    <label class="col-md-2 form-control-label">@lang('backend_media.tabs.content.overview.is_active')</label>

                    <div class="col-md-10">
                        <div class="form-control bg-white">@if($medium->is_active) @lang('strings.yes') @else @lang('strings.no') @endif</div>
                    </div><!--col-->
                </div><!--form-group-->
            </div><!--col-->
        </div><!--row-->
